                          ...
                          <input id="model" data-toggle="modal" data-target=".bs-example-modal-sm" class="btn btn-danger"  style="visibility: hidden;" type="button" value="">
                            <div class="card-body">
                              <ul class="nav nav-tabs" role="tablist">
                                 <li class="nav-item">
                                    @if(@$_GET['type']=='')
                                     <a class="property-tab nav-link active" href="{{url('property')}}<?php if(isset($_GET['p'])){ echo '?p='.$_GET['p'];} ?>" role="tab"><span class="d-none d-md-inline-block">All property</span> 
                                     </a>
                                     @else
                                     <a class="property-tab nav-link" href="{{url('property')}}<?php if(isset($_GET['p'])){ echo "?p=".$_GET['p'];} ?>" role="tab"><span class="d-none d-md-inline-block">All property</span> 
                                     </a>
                                     @endif
                                 </li>
                                 <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    @if(@$_GET['type']=='upcoming')
                                     <a class="property-tab nav-link active" href="{{url('property')}}?<?php if(isset($_GET['p'])){ echo "p=".$_GET['p']."&";} ?>type=upcoming" role="tab">
                                       <span class="d-none d-md-inline-block">Upcoming</span><span class="badge badge-pill badge-success @if($upcoming==0) hide @endif">{{$upcoming}}</span>
                                     </a>
                                     @else
                             ...
                             <div class="tab-content pt-4">
                                 <div class="tab-pane active" id="home" role="tabpanel">
                                  ...
                                  <div class="row">
                                    ...
                                    <table class="table table-striped property_table" style="border-collapse: collapse; border-spacing: 0;">
                                       <thead>
