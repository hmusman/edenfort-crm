...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Unknown Error | Edenfort CRM</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h1 class="mt-5 text-uppercase text-white font-weight-bold mb-3">Something Went Wrong!</h1>
                            <h5 class="text-white-50">We will be back soon. Please try again later.</h5>
                            <div class="mt-5">
                                @if(!session("user_id"))
