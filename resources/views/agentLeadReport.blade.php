...
@if(@$permissions->leadAdd==1) 
    ...
    <li class="nav-item">
      @if(@$_GET['type']=='')
            <a href="{{url('agentLead')}}" class="nav-link active py-3">All Leads</a>
              @else
               <a href="{{url('agentLead')}}" class="nav-link py-3">All Leads</a>
               @endif 
           </li>
           <li class="nav-item">
            @if(@$_GET['type']=='Rent' )
            <a href="{{url('agentLead')}}?type=Rent" class="nav-link active py-3">  Rent</a>
            @else
            <a href="{{url('agentLead')}}?type=Rent" class="nav-link  py-3"> Rent</a>
            @endif
           </li>
                      <li class="nav-item">
                       @if(@$_GET['type']=='Sale' )
            <a href="{{url('agentLead')}}?type=Sale" class="nav-link active py-3">  Sale</a>
            @else
            <a href="{{url('agentLead')}}?type=Sale" class="nav-link  py-3"> Sale</a>
            @endif
           </li>
                      <li class="nav-item">
                       @if(@$_GET['type']=='Reminder' )
            <a href="{{url('agentLead')}}?type=Reminder" class="nav-link active py-3">  Reminder</a>
            @else
            <a href="{{url('agentLead')}}?type=Reminder" class="nav-link  py-3"> Reminder</a>
            @endif
           </li>
          ...
          @if(@$_GET['type']=='Rent' && @$_GET['priority']=='A')
            <a href="{{url('agentLead')}}?type=Rent&priority=A" class="nav-link active py-3">  <label  style="cursor: pointer;line-height: 30px; font-size:28px !important; padding-left:15px; padding-right:15px;" class="label label-success ">A</label></a>
          @elseif(@$_GET['type']=='Rent' )
           <a href="{{url('agentLead')}}?type=Rent&priority=A" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px;  font-size:28px !important; background:#1976D2; padding-left:15px; padding-right:15px;" class="label label-dange ">A</label></a>
         @elseif(@$_GET['type']=='Sale' && @$_GET['priority']=='A')
            <a href="{{url('agentLead')}}?type=Sale&priority=A" class="nav-link active py-3">  <label  style="cursor: pointer;line-height: 30px; font-size:28px !important; padding-left:15px; padding-right:15px;" class="label label-success ">A</label></a>
          @elseif(@$_GET['type']=='Sale' )
           <a href="{{url('agentLead')}}?type=Sale&priority=A" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px;  font-size:28px !important; background:#1976D2; padding-left:15px; padding-right:15px;" class="label label-danger ">A</label></a>
           @endif
          <!--B Priority--> 
            @if(@$_GET['type']=='Rent' && @$_GET['priority']=='B')
            <a href="{{url('agentLead')}}?type=Rent&priority=B" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px; font-size:28px !important; padding-left:15px; padding-right:15px;" class="label label-success ">B</label></a>
          @elseif(@$_GET['type']=='Rent' )
           <a href="{{url('agentLead')}}?type=Rent&priority=B" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px;  font-size:28px !important; background:#1976D2; padding-left:15px; padding-right:15px;" class="label label-danger ">B</label></a>
         @elseif(@$_GET['type']=='Sale' && @$_GET['priority']=='B')
            <a href="{{url('agentLead')}}?type=Sale&priority=B" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px; font-size:28px !important; padding-left:15px; padding-right:15px;" class="label label-success ">B</label></a>
          @elseif(@$_GET['type']=='Sale' )
           <a href="{{url('agentLead')}}?type=Sale&priority=B" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px;  font-size:28px !important; background:#1976D2; padding-left:15px; padding-right:15px;" class="label label-danger ">B</label></a>
           @endif
    <!-- C Priority-->
     @if(@$_GET['type']=='Rent' && @$_GET['priority']=='C')
            <a href="{{url('agentLead')}}?type=Rent&priority=C" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px; font-size:28px !important; padding-left:15px; padding-right:15px;" class="label label-success ">C</label></a>
          @elseif(@$_GET['type']=='Rent' )
           <a href="{{url('agentLead')}}?type=Rent&priority=C" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px;  font-size:28px !important; background:#1976D2; padding-left:15px; padding-right:15px;" class="label label-danger ">C</label></a>
         @elseif(@$_GET['type']=='Sale' && @$_GET['priority']=='C')
            <a href="{{url('agentLead')}}?type=Sale&priority=C" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px; font-size:28px !important; padding-left:15px; padding-right:15px;" class="label label-success ">C</label></a>
          @elseif(@$_GET['type']=='Sale' )
           <a href="{{url('agentLead')}}?type=Sale&priority=C" class="nav-link active py-3">  <label  style="cursor: pointer; line-height: 30px;  font-size:28px !important; background:#1976D2; padding-left:15px; padding-right:15px;" class="label label-danger ">C</label></a>
           @endif
...
@if(@$permissions->leadBulk==1)                 
                     ...
                     <td class="lClient" >{{$lead->client_name}}</td>
                                               ...
                                               <td class="lUser">{{$lead->lead_user}}</td>
...
<label data-toggle="modal" data-target="#assignLeadModal" style="cursor: pointer;position: relative;right: 5px;display: table-cell;" class="assignPopup" name="{{$lead->id}}"><i class="fa fa-edit"></i> Assign</label>
